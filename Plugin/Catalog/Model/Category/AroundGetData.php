...
namespace MageSuite\AttributeProcessor\Plugin\Catalog\Model\Category;
...
class AroundGetData
{
    ...
    public function aroundGetData(
        ...
        if ($processor = $this->processorRepository->get(\Magento\Catalog\Model\Category::ENTITY, $key)) {
            return $processor->getValue($category, $key, $index, $proceed($key, $index));
        }
